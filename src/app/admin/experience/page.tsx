...
import { Plus, Trash2, Edit2, X, Eye, Code, Languages, ChevronUp, ChevronDown } from "lucide-react";
...
- دمجت الذكاء الاصطناعي..." 
      ...
      <style jsx>{`
        ...
        .add-btn { display: flex; align-items: center; gap: 0.5rem; background: #7628E5; color: white; border: none; padding: 10px 20px; border-radius: 8px; cursor: pointer; }
        .exp-list { display: flex; flex-direction: column; gap: 1rem; }
        .exp-card { display: flex; justify-content: space-between; align-items: center; padding: 1.5rem; border-radius: 12px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); gap: 1rem; }
        
        .order-controls { display: flex; flex-direction: column; align-items: center; gap: 4px; }
        .order-btn { background: transparent; border: 1px solid rgba(255,255,255,0.1); color: rgba(255,255,255,0.6); cursor: pointer; padding: 4px; border-radius: 4px; transition: all 0.2s; }
        .order-btn:hover:not(:disabled) { background: rgba(118,40,229,0.2); border-color: #7628E5; color: white; }
        .order-btn:disabled { opacity: 0.3; cursor: not-allowed; }
        .order-num { font-size: 0.75rem; font-weight: 600; color: rgba(255,255,255,0.4); min-width: 20px; text-align: center; }
        ...
        .modal { width: 100%; max-width: 700px; padding: 2rem; border-radius: 20px; background: #111; position: relative; }
        ...
        .lang-toggle { display: flex; gap: 4px; background: #000; padding: 4px; border-radius: 8px; }
        .lang-toggle button { display: flex; align-items: center; gap: 6px; border: none; background: transparent; color: rgba(255,255,255,0.4); padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 0.75rem; font-weight: 600; }
        ...
        .tabs button.active { background: #7628E5; color: white; }
        ...
        input:focus, textarea:focus { border-color: #7628E5; }
        input[type="number"] { -moz-appearance: textfield; }
        input[type="number"]::-webkit-outer-spin-button,
        input[type="number"]::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; }
        .rtl-input { text-align: right; direction: rtl; }
        .save-btn { background: #7628E5; color: white; border: none; padding: 12px; border-radius: 8px; cursor: pointer; font-weight: 600; margin-top: 1rem; transition: 0.3s; }
        .save-btn:hover { background: #621cc4; transform: translateY(-2px); }
      `}</style>
    </div>
  );
}

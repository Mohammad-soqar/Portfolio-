    ...
    <div className="p-6 md:p-12 flex flex-col gap-8 md:gap-12">
      <header className="flex justify-between items-center">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2">
            {t("admin.welcome")},{" "}
            <span className="text-[#7628E5]">
              {user?.email?.split("@")[0].toUpperCase() || "OWNER"}
            </span>
          </h1>
          <p className="text-white/30 font-bold tracking-[0.2em] text-[10px] md:text-[11px] uppercase">
            {t("admin.portfolioEngine")}
          </p>
        </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <ArrowUpRight
            className="absolute top-6 right-6 text-white/10 group-hover:text-purple-400/50 transition-colors"
            size={20}
          />
        </motion.div>
        ...
        >
          ...
          <ArrowUpRight
            className="absolute top-6 right-6 text-white/10 group-hover:text-blue-400/50 transition-colors"
            size={20}
          />
        </motion.div>
        ...
        >
          ...
          <ArrowUpRight
            className="absolute top-6 right-6 text-white/10 group-hover:text-emerald-400/50 transition-colors"
            size={20}
          />
        </motion.div>
      </div>
        ...
        <section className="bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col gap-6 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              >
                <div className="text-white/20 group-hover:text-inherit transition-colors">
                  {action.icon}
                </div>

...
export default function ProjectPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#7628E5] selection:text-white overflow-x-hidden">
      {/* 1. FIXED NAV */}
      <nav className="fixed top-0 w-full z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5 transition-all duration-300">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 h-20 flex justify-between items-center">
          <div className="flex items-center gap-6 md:gap-8 flex-1">
            ...
            >
              <div className="p-2 rounded-full border border-white/10 group-hover:border-[#7628E5] transition-colors">
                <ArrowLeft size={16} />
              </div>
          ...
          <div className="flex items-center gap-4">
            {project.projectLink && (
              <a
                ...
                target="_blank"
                className="bg-[#7628E5] text-white border border-[#7628E5] hover:bg-[#6020c0] hover:shadow-[0_0_20px_#7628E5] rounded-full px-6 py-2.5 font-bold text-xs flex items-center gap-2 transition-all duration-300 transform hover:-translate-y-0.5"
              >
          ...
          >
            <span
              className={`text-[10px] font-black uppercase tracking-widest transition-all duration-300 ${
                activeSection === s.id
                  ? "opacity-100 translate-x-0 text-[#7628E5]"
            ...
            <div
              className={`w-2 h-2 rounded-full border transition-all duration-300 ${
                activeSection === s.id
                  ? "bg-[#7628E5] border-[#7628E5] scale-150 shadow-[0_0_10px_#7628E5]"
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50vw] h-[50vh] bg-[#7628E5] blur-[150px] opacity-20 animate-pulse pointer-events-none"></div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 w-full relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 font-black text-xs tracking-[0.2em] text-[#7628E5] mb-8 uppercase bg-[#7628E5]/5 px-4 py-2 rounded-full border border-[#7628E5]/20 shadow-[0_0_15px_rgba(118,40,229,0.1)]"
          >
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              ...
              <div className="text-lg leading-relaxed opacity-80 space-y-6 prose prose-invert max-w-none prose-strong:text-[#7628E5]">
            ...
            <div className="lg:sticky lg:top-32">
              <div className="bg-gradient-to-br from-[#111] to-black border border-white/10 p-8 md:p-12 rounded-[32px] shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#7628E5] blur-[100px] opacity-10 group-hover:opacity-20 transition-opacity"></div>
                <h3 className="text-xs font-black uppercase tracking-[0.15em] text-[#7628E5] mb-8 relative z-10">
                ...
                <div className="flex flex-wrap gap-2.5 relative z-10">
                  {project.techStack?.map((t) => (
                    <span
                      key={t}
                      className="bg-white/5 border border-white/10 hover:border-[#7628E5] hover:text-[#7628E5] text-white/80 px-4 py-2 rounded-xl text-sm font-bold transition-all duration-300"
                    >
                      {t}
                    </span>
                  ))}
      ...
      {/* 4b. FEATURES SECTION */}
      {(project.features || project.features_ar) && (
        <section id="features" className="py-24 md:py-32 relative z-10">
          <div className="max-w-[1200px] mx-auto px-6 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                <span className="text-xs font-black uppercase tracking-[0.2em] text-[#7628E5] mb-4 block">
              ...
              <div className="bg-gradient-to-br from-[#0A0A0A] to-[#111] border border-white/10 p-8 md:p-10 rounded-[32px] shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 left-0 w-48 h-48 bg-[#7628E5] blur-[100px] opacity-10 group-hover:opacity-20 transition-opacity"></div>
                <div className="relative z-10 prose prose-invert prose-lg max-w-none prose-li:marker:text-[#7628E5] prose-ul:space-y-3 prose-li:text-white/80">
                  <ReactMarkdown remarkPlugins={[remarkGfm]}>
      ...
      {(project.longDescription || project.longDescription_ar) && (
        <section
          id="story"
        ...
        >
          ...
          <div className="max-w-[900px] mx-auto px-6 md:px-8 relative z-10">
            ...
            <div className="prose prose-invert prose-lg max-w-none prose-strong:text-[#7628E5] prose-headings:text-white prose-headings:font-black prose-p:text-white/70 prose-p:leading-relaxed prose-ul:space-y-2 prose-li:marker:text-[#7628E5]">
              <ReactMarkdown remarkPlugins={[remarkGfm]}>
                {getLocalized(
                  project.longDescription,
                  project.longDescription_ar,
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="lg:order-1 bg-gradient-to-br from-[#0A0A0A] to-[#111] border border-white/10 p-8 md:p-10 rounded-[32px] shadow-2xl relative overflow-hidden group">
                <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#7628E5] blur-[100px] opacity-10 group-hover:opacity-20 transition-opacity"></div>
                <div className="relative z-10 prose prose-invert prose-lg max-w-none prose-li:marker:text-[#7628E5] prose-ul:space-y-3 prose-li:text-white/80">
                  <ReactMarkdown remarkPlugins={[remarkGfm]}>
      ...
      <section id="journey" className="py-24 md:py-32 relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop offset="50%" stopColor="#7628E5" />
            ...
            <div className="md:hidden absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#7628E5]/50 to-transparent"></div>
            ...
            <div className="space-y-4 md:space-y-0 relative">
              {project.journey?.map((phase, idx) => (
                ...
                >
                  ...
                  <div
                    className={`w-full md:w-[45%] bg-[#0A0A0A] border border-white/10 p-8 rounded-3xl shadow-2xl relative group hover:border-[#7628E5] transition-all duration-300 mt-16 md:mt-0
                  ${idx % 2 === 0 ? "md:mr-auto" : "md:ml-auto md:text-right"}
                `}
                  >
                    {/* Glow effect on hover */}
                    <div className="absolute inset-0 bg-[#7628E5] opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-300"></div>

                    <div
                      className={`flex items-center gap-4 mb-4 ${idx % 2 !== 0 && "md:flex-row-reverse"}`}
                    >
                      <span className="text-3xl md:text-4xl font-black text-white/5 group-hover:text-[#7628E5]/20 transition-colors">
                        0{idx + 1}
                      </span>
                  ...
                  <div
                    className={`
                    absolute left-1/2 -translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2 
                    w-12 h-12 rounded-full bg-[#050505] border-4 border-[#7628E5] shadow-[0_0_20px_#7628E5]
                    z-20 flex items-center justify-center text-[#7628E5]
                    ${idx === 0 ? "md:-mt-20" : ""}
                `}
                  >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-8">
          ...
          <div className="rounded-[40px] overflow-hidden bg-[#080808] border border-white/5 shadow-2xl relative group">
            <div className="h-[50vh] md:h-[80vh] relative flex items-center justify-center bg-[url('/images/grid.svg')] bg-cover bg-center">
              ...
              {/* Navigation Arrows */}
              <button
                className="absolute left-6 md:left-10 top-1/2 -translate-y-1/2 p-4 rounded-full bg-black/50 backdrop-blur-md border border-white/10 text-white hover:bg-[#7628E5] hover:border-[#7628E5] transition-all duration-300 z-20 group-hover:opacity-100 opacity-0 translate-x-[-20px] group-hover:translate-x-0"
                onClick={() =>
                  setActiveImg((p) =>
              ...
              <button
                className="absolute right-6 md:right-10 top-1/2 -translate-y-1/2 p-4 rounded-full bg-black/50 backdrop-blur-md border border-white/10 text-white hover:bg-[#7628E5] hover:border-[#7628E5] transition-all duration-300 z-20 group-hover:opacity-100 opacity-0 translate-x-[20px] group-hover:translate-x-0"
                onClick={() =>
                  setActiveImg((p) =>
            ...
            <div className="p-6 md:p-8 flex justify-center gap-4 border-t border-white/5 bg-[#050505] overflow-x-auto">
              {project.images?.map((img, i) => (
                <button
                  key={i}
                  className={`relative w-24 h-16 rounded-lg overflow-hidden border-2 transition-all duration-300 flex-shrink-0 ${activeImg === i ? "border-[#7628E5] opacity-100 scale-105" : "border-transparent opacity-40 hover:opacity-100"}`}
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="lg:order-2">
              ...
              <div className="text-lg leading-relaxed opacity-80 prose prose-invert max-w-none prose-ul:list-disc prose-li:marker:text-[#7628E5]">
                <ReactMarkdown remarkPlugins={[remarkGfm]}>
            ...
            <div className="flex justify-center lg:order-1">
              <div className="relative bg-[#0A0A0A] border border-white/10 p-12 md:p-16 rounded-[40px] text-center w-full max-w-md overflow-hidden group">
                <div className="absolute top-0 right-0 w-40 h-40 bg-[#7628E5] blur-[80px] opacity-20 group-hover:opacity-40 transition-opacity"></div>
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-20 h-20 rounded-2xl bg-[#7628E5] flex items-center justify-center shadow-[0_0_30px_rgba(118,40,229,0.4)] mb-8 transform group-hover:scale-110 transition-transform">
      ...
      <footer className="py-20 text-center border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-6">
          <button
            ...
            className="group border border-white/10 bg-white/5 text-white px-10 py-4 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-[#7628E5] hover:border-[#7628E5] transition-all"
          >

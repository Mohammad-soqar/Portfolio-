export const data = {
  ...
  aboutMe: {
    ...
    personalInfo: {
      ...
      aboutnme: "Hi, I'm Mohammad Soqar, a Software Engineer with expertise in full-stack and mobile development, specializing in Flutter, ASP.NET MVC, React, and Node.js. I recently graduated from Üsküdar University, where I developed LocaLink, a location-based social media app that fosters community engagement. With four years of experience, I’ve had the opportunity to work on a variety of projects across different domains. My work includes developing LocaLink, a social media app focused on community engagement; building Zoom Tourism, a CRM system for managing travel and tourism; and designing the UI/UX for Reson8 Media’s website. Additionally, I've worked on Zoom Medical, a beauty and cosmetics booking system integrated with CRM functionalities; and Codyle, a platform for organizing and managing tech events. These experiences have allowed me to develop a strong foundation in both mobile and web development, utilizing technologies such as Flutter, ASP.NET, React, and more.",
